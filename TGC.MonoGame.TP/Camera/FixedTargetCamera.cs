...
namespace TGC.MonoGame.TP.Cameras
{
    ...
    /// </summary>
    public class FixedTargetCamera : Camera
    {
        /// <summary>
        ...
        public FixedTargetCamera(float aspectRatio, Vector3 position, Vector3 targetPosition) : base(aspectRatio)
        {
        ...
        public FixedTargetCamera(float aspectRatio, Vector3 position, Vector3 targetPosition, float nearPlaneDistance,
